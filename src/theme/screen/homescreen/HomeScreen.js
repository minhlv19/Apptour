    ...
    render() {
        return (
            ...
            <View style={{flex: 1}}>
                ...
                <View style={{
                    margin: 10, borderRadius: 10, marginTop: -50, flex: 2, padding: 10,
                    elevation: 7, backgroundColor: '#fff'
                }}>
                    <View style={{flexDirection: 'row',}}>
                        <View style={{flex: 1}}>
                            <Text style={{fontSize: 16, color: '#4a4a4a'}}>Check-in date</Text>
                            <View style={{
                                marginTop: 5,
                                width: '95%',
                                flexDirection: 'row',
                        ...
                        <View style={{flex: 1}}>
                            <Text style={{fontSize: 16, color: '#4a4a4a'}}>Check-out date</Text>
                            <View style={{
                                marginTop: 5,
                                width: '95%',
                                flexDirection: 'row',
                    ...
                    <View>
                        <Text style={{fontSize: 16, marginTop: 10, marginBottom: 10, color: '#4a4a4a'}}>Durations</Text>
                        <View style={{flex: 1, flexDirection: 'row', justifyContent: 'flex-end', marginBottom: 10}}>
                            <View style={{
                                ...
                                <View style={{margin: -10,}}>
                                    <Text style={{width: 200, borderBottomWidth: 1, marginLeft: 20}}>25</Text>
                                    <Text></Text>
                                </View>
                                <Text style={{fontSize: 16, marginLeft: 10, padding: 10}}>50</Text>
                            </View>
                ...
                <View style={{flex: 2, marginLeft: 10}}>
                    <Text style={{fontSize: 18, color: '#000'}}>On- going Promotion </Text>
                    <FlatList data={items_n} renderItem={({item}) =>
                        <View>
                            <Text>{item.name}</Text>
